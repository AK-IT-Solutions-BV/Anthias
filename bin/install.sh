...
REPOSITORY="https://github.com/AK-IT-Solutions-BV/Anthias.git"
ANTHIAS_REPO_DIR="/home/${USER}/screenly"
GITHUB_API_REPO_URL="https://api.github.com/repos/AK-IT-Solutions-BV/Anthias"
GITHUB_RELEASES_URL="https://github.com/AK-IT-Solutions-BV/Anthias/releases"
GITHUB_RAW_URL="https://raw.githubusercontent.com/AK-IT-Solutions-BV/Anthias"
DOCKER_TAG="latest"
...
function install_ansible() {
    ...
    # See https://github.com/AK-IT-Solutions-BV/Anthias/issues/1654 for details.
...
function set_custom_version() {
    ...
    # Skip validation and assume the branch exists
    gum style "Using branch/tag: $BRANCH" | gum format
    echo
    
    # Always use the latest docker tag
    DOCKER_TAG="latest"
}
